...
echo directorypress_display_template($template, array('public_handler' => $public_handler)); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- done already