...
<?php if(isset($DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_single_listing_views']) && $DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_single_listing_views']): ?>
	<div class="listing-views">
		...
		?>
		<?php echo sprintf(esc_html__('Views: %d', 'DIRECTORYPRESS'), (get_post_meta($listing->post->ID, '_total_clicks', true) ? esc_attr(get_post_meta($listing->post->ID, '_total_clicks', true)) : 0)); ?>
	</div>
<?php endif; ?>