	...
	<?php if (($fields_groups = $listing->get_fields_groups_in_tabs()) || ($listing->is_map() && $listing->locations) || (directorypress_is_reviews_allowed()) || ($listing->package->videos_allowed && $listing->videos) || $DIRECTORYPRESS_ADIMN_SETTINGS['message_system'] == 'email_messages'): ?>
		<?php if(wp_is_mobile()){ ?>
								<ul class="directorypress-listing-tabs nav navbar-nav clearfix" role="tablist">
									...
									<li><a href="javascript: void(0);" data-tab="#addresses-tab" role="tab"><i class="directorypress-icon-home"></i><?php esc_html_e('Map Views', 'DIRECTORYPRESS'); ?></a></li>
									<?php endif; ?>
									...
									<li><a href="javascript: void(0);" data-tab="#comments-tab" role="tab"><i class="directorypress-icon-comments-o"></i><?php echo esc_html(_n('Comment', 'Comments', esc_attr($listing->post->comment_count), 'DIRECTORYPRESS')); ?> (<?php echo esc_attr($listing->post->comment_count); ?>)</a></li>
									<?php endif; ?>
									...
									<li><a href="javascript: void(0);" data-tab="#videos-tab" role="tab"><i class="directorypress-icon-play"></i><?php echo esc_html(_n('Video', 'Videos', count($listing->videos), 'DIRECTORYPRESS')); ?> (<?php echo esc_attr(count($listing->videos)); ?>)</a></li>
									<?php endif; ?>
									<?php
		...
		<?php }else{ ?>
			<ul class="directorypress-listing-tabs nav nav-tabs clearfix" role="tablist">
									...
									<li><a href="javascript: void(0);" data-tab="#addresses-tab" data-bs-toggle="directorypress-tab" role="tab"><i class="directorypress-icon-home"></i><?php esc_html_e('Map Views', 'DIRECTORYPRESS'); ?></a></li>
									<?php endif; ?>
									<?php if (directorypress_is_reviews_allowed() && $DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_listings_comments_position'] == 'intab' && in_array('comments-tab', $default_tab_keys)): ?>
									<li><a href="javascript: void(0);" data-tab="#comments-tab" data-bs-toggle="directorypress-tab" role="tab"><i class="directorypress-icon-comments-o"></i><?php echo esc_html(_n('Comment', 'Comments', $listing->post->comment_count, 'DIRECTORYPRESS')); ?> (<?php echo esc_attr($listing->post->comment_count); ?>)</a></li>
									<?php endif; ?>
									<?php if ($listing->package->videos_allowed && $listing->videos && $DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_listings_video_position'] == 'intab'  && in_array('videos-tab', $default_tab_keys)): ?>
									<li><a href="javascript: void(0);" data-tab="#videos-tab" data-bs-toggle="directorypress-tab" role="tab"><i class="directorypress-icon-play"></i><?php echo esc_html(_n('Video', 'Videos', count($listing->videos), 'DIRECTORYPRESS')); ?> (<?php echo esc_attr(count($listing->videos)); ?>)</a></li>
									<?php endif; ?>
									<?php
									foreach ($fields_groups AS $fields_group): ?>
									<li><a href="javascript: void(0);" data-tab="#field-group-tab-<?php echo esc_attr($fields_group->id); ?>" data-bs-toggle="directorypress-tab" role="tab"><?php echo esc_html($fields_group->name); ?></a></li>
									<?php endforeach; ?>
			</ul>
		<?php } ?>
