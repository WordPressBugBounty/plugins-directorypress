		...
		<div class="theme-browser rendered">
			<div class="directorypress-box">
				<div class="directorypress-box-head">
					<?php esc_html_e('Change expiration date', 'DIRECTORYPRESS'); ?>
				</div>
				<div class="directorypress-box-content wp-clearfix">
					...
					<form action="<?php echo esc_url(admin_url('options.php?page=directorypress_changedate&listing_id=' . esc_attr($listing->post->ID)) . '&changedate_action=changedate&referer=' . urlencode($referer)); ?>" method="POST">
						<p>
							...
							&nbsp;&nbsp;&nbsp;<?php esc_html_e('Time:', 'DIRECTORYPRESS'); ?>
						...
						<?php if ($action == 'show'): ?>
						<input type="submit" value="<?php esc_attr_e('Save changes', 'DIRECTORYPRESS'); ?>" class="button button-primary" id="submit" name="submit">
						&nbsp;&nbsp;&nbsp;
