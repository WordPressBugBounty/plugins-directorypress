	...
	(function($) {
		...
		window.directorypress_video_attachment_tpl = function(video_id, image_url) {
			var video_attachment_tpl = '<div class="directorypress-attached-item">'+
				...
				'<div class="directorypress-attached-item-img"><img src="'+image_url+'" alt="<?php esc_attr_e("Video Thumbnail", "DIRECTORYPRESS"); ?>" /></div>'+
				'<div class="thumb-links clearfix"><div class="directorypress-attached-item-delete dicode-material-icons dicode-material-icons-trash-can-outline" title="<?php esc_attr_e("delete", "DIRECTORYPRESS"); ?>"></div></div>'+
			'</div>';
...
<div id="directorypress-video-attach-wrapper" class="">
	<p class="directorypress-submit-field-title"><?php esc_html_e("Listing videos", "DIRECTORYPRESS"); ?></p>
	...
	<div id="directorypress-attached-videos-wrapper">
		...
		<div class="directorypress-attached-item">
			...
			<?php if (strlen($video['id']) == 11 || strlen($video['id']) == 8 || strlen($video['id']) == 9): ?>
				...
				<div class="directorypress-attached-item-img"><img src="<?php echo esc_url($image_url); ?>" alt="<?php esc_attr_e("Video Thumbnail", "DIRECTORYPRESS"); ?>" /></div>
			<?php endif; ?>
			<div class="thumb-links clearfix">
				<div class="directorypress-attached-item-delete dicode-material-icons dicode-material-icons-trash-can-outline" title="<?php esc_attr_e("delete", "DIRECTORYPRESS"); ?>"></div>
			</div>
	...
	<div id="directorypress-attach-videos-functions">
		<div class="directorypress-upload-option">
			<input type="text" id="directorypress-attach-video-input" class="form-control" placeholder="<?php esc_attr_e('Enter full YouTube or Vimeo video link', 'DIRECTORYPRESS'); ?>"  />
