...
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/core/fields/ajax_calls/fields_list.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/core/fields/ajax_calls/create_field.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/core/fields/ajax_calls/edit_field.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/core/fields/ajax_calls/field_options.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/core/fields/ajax_calls/field_search_settings.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/core/fields/ajax_calls/assign_field_group.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/core/fields/ajax_calls/field_sorting.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/core/fields/ajax_calls/delete_field.php';

require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/core/fields/ajax_calls/group_list.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/core/fields/ajax_calls/create_group.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/core/fields/ajax_calls/edit_group.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/core/fields/ajax_calls/delete_group.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/core/fields/ajax_calls/group_sorting.php';
