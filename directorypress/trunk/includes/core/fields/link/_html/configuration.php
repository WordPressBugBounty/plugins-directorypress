<div class="directorypress-modal-content wp-clearfix">
	<form class="config" method="POST" action="">
		...
		<div class="field-holder">
			<div><label><?php esc_html_e('taget _blank? (open in new window)', 'DIRECTORYPRESS'); ?></label></div>
			<div>
				<label class="switch">
		...
		<div class="field-holder">
			<div><label><?php esc_html_e('Nofollow?', 'DIRECTORYPRESS'); ?></label></div>
			<div>
				<label class="switch">
		...
		<div class="field-holder">
			<div><label><?php esc_html_e('Enable custom link text', 'DIRECTORYPRESS'); ?></label></div>
			<div>
				<label class="switch">
		...
		<div class="field-holder">
			<div><label><?php esc_html_e('Add Default text?', 'DIRECTORYPRESS'); ?></label></div>
			<div>
				<label class="switch">
		...
		<div class="field-holder">
			<div><label><?php esc_html_e('Default text', 'DIRECTORYPRESS'); ?></label></div>
			<div>
