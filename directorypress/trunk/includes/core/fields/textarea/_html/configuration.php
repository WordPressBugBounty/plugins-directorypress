<div class="directorypress-modal-content wp-clearfix">
	<form class="config" method="POST" action="">
		...
		<div class="field-holder">
			<div><label><?php esc_html_e('Enable Editor', 'DIRECTORYPRESS'); ?></label></div>
			<div>
				<label class="switch">
		...
		<div class="field-holder">
			<div><label><?php esc_html_e('Allow Shortcode?', 'DIRECTORYPRESS'); ?></label></div>
			<div>
				<label class="switch">
		...
		<div class="field-holder">
			<div><label><?php esc_html_e('Maximum Characters Allowed', 'DIRECTORYPRESS'); ?><span class="directorypress-red-asterisk">*</span></label></div>
			<div>
