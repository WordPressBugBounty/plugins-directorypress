...
* WordPress 6.8.1 comaptibility checked
* Reported vulnerability fixed.
* Elementor comaptibility checked.
* Fatal while listing update from backend, if category number increased from allowed number.
* Backend ui changes to introduce video tutorials sidebar in each section.
* minor fixes

= 3.6.22 =
* Security Improvement
* woocomerce compatibility checked.
* WordPress 6.7.2 comaptibility checked
* directorypress_action replaced with directory_action
* elementor comaptibility checked.
* php 8.2x, 8.3x compatibility improvements.
* minor fixes
