<?php
	...
	echo '<figure class="directorypress-listing-figure">';
		echo '<a href="'.esc_url(get_permalink()).'"><img alt="'. esc_attr($listing->title()).'" src="'. esc_url(bfi_thumb($image_src_w, $param)).'" width="150" height="150" /><span class="listing-widget-hover-overlay"><i class="directorypress-icon-share"></i></span></a>';
	echo '</figure>';