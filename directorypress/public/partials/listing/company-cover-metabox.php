...
<?php if(isset($DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_enable_business_cover']) && $DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_enable_business_cover']): ?>
	...
	<div id="directorypress-images-upload-wrapper" class="cover_image">
		<p class="directorypress-submit-field-title"><?php esc_html_e('Cover Image', 'DIRECTORYPRESS'); ?></p>
		<div id="directorypress-attached-images-wrapper" class="cover_image full clearfix">
			...
			?>
				<div class="directorypress-attached-item cover_image">
					...
					<img src="<?php echo esc_url(bfi_thumb($image_src, $param)); ?>" width="126" height="100" alt="<?php echo esc_attr_e('Cover Image', 'DIRECTORYPRESS'); ?>" />
					<div class="thumb-links clearfix">
						<div class="directorypress-attached-item-delete cover_image dicode-material-icons dicode-material-icons-trash-can-outline" title="<?php esc_html_e("delete", "DIRECTORYPRESS"); ?>"></div>
					</div>
				</div>
			<?php endif; ?>
			<?php if (!is_admin()): ?>
				...
				<div class="directorypress-drop-attached-item cover_image">
					<div class="directorypress-drop-zone cover_image">
						<div class="dropzone-content">
							<span class="drophere"><?php esc_html_e("Drop Your Image Here", "DIRECTORYPRESS"); ?></span>
							<button class="directorypress-upload-item-button cover_image btn btn-primary"><?php esc_html_e("Browse", "DIRECTORYPRESS"); ?></button>
