...
<?php if(isset($DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_single_listing_publish_date']) && $DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_single_listing_publish_date']): ?>
	<div class="directorypress-listing-date" datetime="<?php echo esc_attr(date("Y-m-d", mysql2date('U', $listing->post->post_date))); ?>T<?php echo esc_attr(date("H:i", mysql2date('U', $listing->post->post_date))); ?>">
		<?php
