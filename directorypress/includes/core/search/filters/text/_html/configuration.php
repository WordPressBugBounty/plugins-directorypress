<div class="directorypress-modal-content wp-clearfix">
	<form class="search-config" method="POST" action="">
		...
		<div class="field-holder">
			<div><label><?php esc_html_e('How to show in Search Form', 'DIRECTORYPRESS'); ?></label></div>
			<div>
				<p><?php esc_html_e('Add in keywords field', 'DIRECTORYPRESS')?></p>
				<label class="switch">
					<input name="search_input_mode" type="radio" value="keywords" <?php checked($search_field->search_input_mode, 'keywords'); ?> />
					<span class="slider"></span>
				</label>
				<p><?php esc_html_e('seperate input field', 'DIRECTORYPRESS')?></p>
				<label class="switch">
