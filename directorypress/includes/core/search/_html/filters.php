<?php if ($search_fields): ?>
		...
		<script>
			...
			<?php else: ?>
					fields_in_categories[<?php echo esc_attr($search_field->field->id); ?>] = [<?php echo implode(',', $search_field->field->categories); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- escaped already ?>];
			<?php endif; ?>
			<?php endforeach; ?>
