...
<div class="directorypress-field-item directorypress-field-type-<?php echo esc_attr($field->type); ?>">
	...
	<?php //echo get_the_term_list($listing->post->ID, DIRECTORYPRESS_TAGS_TAX, '', ', ', ''); ?>
		...
		foreach ($terms as $term): ?>
			<span class="directorypress-label directorypress-label-primary"><a href="<?php echo esc_url(get_term_link($term, DIRECTORYPRESS_TAGS_TAX)); ?>" rel="tag"><?php echo esc_html($term->name); ?></a>&nbsp;&nbsp;<span class="glyphicon glyphicon-tag"></span></span>
		<?php endforeach; ?>
	</span>
</div>
<?php endif; ?>