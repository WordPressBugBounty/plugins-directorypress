...
<script>
	(function($) {
		...
		$(function() {
			var max_index = <?php echo ((count(array_keys($field->selection_items)) ? esc_attr(max(array_keys($field->selection_items))) : 1)); ?>;
	...
	<form class="config" method="POST" action="">
		...
		<div class="form-table">
			...
			?>
			<p><label><?php esc_html_e('Selection items:', 'DIRECTORYPRESS'); ?></label></p>
