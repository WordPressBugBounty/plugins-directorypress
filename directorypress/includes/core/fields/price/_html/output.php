<div class="directorypress-field-item directorypress-field-id-<?php echo esc_attr($field->id); ?> directorypress-field-type-<?php echo esc_attr($field->type); ?>">
	...
	<?php echo wp_kses_post($field->formatPrice()); ?>
	</span>
</div>