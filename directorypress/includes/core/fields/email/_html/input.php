...
<div class="field-wrap field-input-item submit_field_id_<?php echo esc_attr($field->id); ?> field-type-<?php echo esc_attr($field->type); ?>">
	...
	<div class="input-group">
		...
		<input type="text" name="directorypress-field-input-<?php echo esc_attr($field->id); ?>" class="form-control" placeholder="<?php esc_html_e('Provide Email Address', 'DIRECTORYPRESS'); ?>" value="<?php echo esc_attr($field->value); ?>" />
	</div>
</div>