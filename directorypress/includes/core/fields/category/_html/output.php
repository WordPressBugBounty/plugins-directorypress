...
<div class="directorypress-field-item directorypress-field-type-<?php echo esc_attr($field->type); ?>">
	...
	<span class="field-content">
		...
		?>
			<span class="directorypress-label directorypress-label-primary"><a style="background-color:<?php echo esc_attr($icon_color); ?>;" href="<?php echo esc_url(get_term_link($term, DIRECTORYPRESS_CATEGORIES_TAX)); ?>" rel="tag"><?php echo esc_html($term->name); ?></a>&nbsp;&nbsp;<span class="glyphicon glyphicon-tag"></span></span>
		<?php endforeach; ?>
	</span>
</div>
<?php endif; ?>