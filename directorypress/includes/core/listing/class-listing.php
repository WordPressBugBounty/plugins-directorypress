...
class directorypress_listing extends directorypress_post{
	...
	public $listing_post_style;
	public $listing_image_width;
	public $listing_image_height;
	public $fchash;
	public $listings_view_type;
	public $listing_has_featured_tag_style;
	...
	public function get_listing_pending_status() {
		if ($this->post->post_status == 'pending') {
			if ($this->status == 'unpaid') {
				return esc_html__('Pending payment', 'DIRECTORYPRESS');
			}
			...
			if ($is_moderation && !$is_approved) {
				return esc_html__('Pending approval', 'DIRECTORYPRESS');
			}
			
			return esc_html__('Pending', 'DIRECTORYPRESS');
		}
	}
