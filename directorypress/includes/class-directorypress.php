...
class DirectoryPress {
	...
	public function elementorWidgetCategories( $elements_manager ) {
		...
		$elements_manager->add_category(
			'directorypress',
			[
				'title' => esc_html__( 'DirectoryPress', 'plugin-name' ),
				'icon' => 'fa fa-plug',
			]
		);
