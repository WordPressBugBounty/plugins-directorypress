...
class DirectoryPress_Elementor_Terms_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Terms', 'DIRECTORYPRESS' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'terms_taxonomy',
			[
				'label' => esc_html__( 'Select A Taxonomy', 'DIRECTORYPRESS' ), 
				'label_block' => true,
		...
		foreach(get_object_taxonomies('dp_listing') AS $key => $tax){
			...
			$this->add_control(
				'terms_'. $tax,
				[
					'label' => esc_html__( 'Select A Term', 'DIRECTORYPRESS' ), 
					'label_block' => true,
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'justify' => [
						'title' => esc_html__( 'Justified', 'DIRECTORYPRESS' ),
		...
		$this->add_responsive_control(
			'title_border_radius',
			[
				'label' => esc_html__( 'Border Radius', 'DIRECTORYPRESS' ),
