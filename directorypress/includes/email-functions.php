...
if ( !function_exists('wp_new_user_notification') ) {
    ...
    function wp_new_user_notification( $user_id, $deprecated = null, $notify = 'both' ) {
			...
			$message  = sprintf(esc_html__('New user registration on your site %s:', 'DIRECTORYPRESS'), $blogname) . "<br />";
			$message .= sprintf(esc_html__('Username: %s', 'DIRECTORYPRESS'), $user->user_login) . "<br />";
			$message .= sprintf(esc_html__('E-mail: %s', 'DIRECTORYPRESS'), $user->user_email) . "<br />";
			$message .= "<br /><br />";
			$message .= 'Thank you';
			...
			@wp_mail(get_option('admin_email'), sprintf(esc_html__('[%s] New User Registration', 'DIRECTORYPRESS'), $blogname), $message, $headers);
			...
			add_filter('wp_mail_content_type', 'directorypress_set_html_mail_content_type');
			wp_mail($user->user_email, sprintf(esc_html__('[%s] Your username and password info', 'DIRECTORYPRESS'), $blogname), $message, $headers );
